...
if __name__=='__main__':
    ...
    path = 'C:\\Users\\Esther\\Documents\\VisualDS\\Spatial-DS-Edwards\\VisDSAssignments\\Program3\\JsonFilesCreated\\'
    # Open our condensed json file to extract points
    for year in range(1960,2017):
        #f = open(path+'quake-'+str(year)+'-condensed.json','r')
        with open(path+'quake-'+str(year)+'-condensed.json','r') as f:
    ...
    f = open(path+'quake-adjusted.json','w')
