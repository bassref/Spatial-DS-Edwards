...
def main():
    ...
    bg = pygame.image.load('C:\\Users\\Esther\\Documents\\VisualDS\\Spatial-DS-Edwards\\Assignments\\Program_6\\bg-map.png')
   
    screen.blit(bg, (0,0))
    pygame.display.flip()

    file_name = "C:\\Users\\Esther\\Documents\\VisualDS\\Spatial-DS-Edwards\\Assignments\\Program_6\\attacks.json"
